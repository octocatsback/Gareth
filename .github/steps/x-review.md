...
- **Added a new source site to the workflow** — You updated the workflow to include the [awesome-copilot workflows](https://github.com/github/awesome-copilot/tree/main/workflows) repository as a source for `.github/workflows/update-github-info.md` and recompiled it.
